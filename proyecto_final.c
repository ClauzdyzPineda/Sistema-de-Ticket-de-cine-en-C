...
void actualizarRegistro(char *registro)
{
            ...
            while (fread(&Usuario, sizeof(Usuario), 1, file))
            {
                ...
                else
                {
                    ...
                    do
                    {
						...
						printf("\t\tACTUALIZACION DE DATOS DEL USUARIO\N");
                        switch (opcion)
                        {
                        case 1:
                           	printf("\n-------------------------------------------------------------------\n");
            ...
            while (fread(&Pelicula, sizeof(Pelicula), 1, file))
            {
                ...
                else
                {
                    ...
                    do
                    {
						...
						printf("\n\t\tDATO SELECCIONADO A MODIFICAR DE PELICULA\n");
                        switch (opcion)
                        {
                         case 1:
                        	printf("\n-----------------------------------------------------------\n");
    ...
    if (strcmp(registro, SALA) == 0)
    {
        ...
        do
        {
            ...
            titulo();
            cabeceraMenuSalas();
           	printf("\n\tIngrese el numero de sala a agregar \n\n");
        ...
        while (tecla != ENTER)
        {
			...
			printf("\n\tElija la pelicula a agregar en el numero de sala ingresado\n\n");
...
void mostrarReportes()
{
    ...
    if (access(ARCHIVO_TICKETS, F_OK) == -1)
    {
